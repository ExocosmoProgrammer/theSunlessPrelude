...
class drone:
            ...
            try:
                ...
                # commander will be immune to your drone's attack.
                    ...
                    if enemy.twirlingNunchucks:
                        ...
                        printWithPause(0.5, '\033[31m', f'{enemy.getPrintName()} deflected your drone\'s'
    ...
    def showHp(self, protagonist):
        ...
        printWithPause(0.5, '\033[00m', '[', '\033[34m', f'{"_" * hpDashCount}{" " * emptySpaceCount}',
                       '\033[00m', ']')
    ...
    def getHurtByDebuffs(self):
        ...
        if self.burningDamage:
            ...
            printWithPause(0.5, '\033[31m', f'Your drone took {self.burningDamage} damage from bleeding.')

...
class drone:
        ...
        if enemies:
            ...
            try:
                ...
                # commander will be immune to your drone's attack.
                    ...
                    printWithPause(0.5, '\033[35m', f'Your drone hit {enemy.getPrintName()}, but they were '
                                                    f'immune.')

                else:
                    damageInflicted = getReducedDamage(protagonist.attack / 2, enemy)
                    printWithPause(0.5, '\033[35m', f'Your drone hit {enemy.getPrintName()}, inflicting '
                                                    f'{damageInflicted} '
                                                    f'damage.')
    ...
    def showHp(self, protagonist):
        ...
        printWithPause(0.5, '\033[97m', '[', '\033[35m', f'{"_" * hpDashCount}{" " * emptySpaceCount}',
                       '\033[97m', ']')

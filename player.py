...
class player:
    ...
    def useSolution(self, enemies):
        if 'solution' in self.inventory:
            ...
            try:
                ...
                if enemy.type == 'alien priest' and [foe for foe in enemies if foe.type in ['alien worshipper',
                                                                                            'alien cardinal']
                                                                               and foe.hp > 0 and foe.possessed ==
                                                                               enemy.possessed]:
    ...
    def actions(self, enemies, level):
        ...
        if not self.sunPriestSpotted and self.enemiesKilledInLevelFour >= 15:
            ...
            printWithPause(5, '\033[31m', "You have made a gap in the mob surrounding you. "

...
lootPerFoe = {'alien colonist': {'regen': 15}, 'alien bodyguard': {'shield': 15},
              ...
              'alien secret service': {'gun': 15}, 'alien assassin': {'stun grenade': 100, 'gas canister': 15},
              'alien minion': {'throwing knife': 100, 'radio': 15},
              'alien scientist': {'solution': 100, 'hissing cockroach': 15, 'combustible lemon': 1},
              'alien general': {'sword': 50, 'drone': 15},
              'alien henchman': {'armor': 50, 'serrated knife': 100, 'vial of diseased blood': 15},
              'alien combat scientist': {'solution': 100, 'hissing cockroach': 15, 'combustible lemon': 1},

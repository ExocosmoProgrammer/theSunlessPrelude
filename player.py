...
class player:
    ...
    def showHp(self):
        ...
        printWithPause(0.5, '\033[37m', '[', '\033[31m', f'{"_" * hpDashCount}{" " * emptySpaceCount}',
                       '\033[37m', ']')
        printWithPause(0.5, '\033[96m', "Upgrade items:", '\033[37m', f"{upgradeInventory}")

        if oneTimeItemInventory:
            printWithPause(0.5, '\033[96m', "One time use items:", '\033[37m', f"{oneTimeItemInventory}")

        if self.souls:
            printWithPause(0.5, '\033[96m', "Souls:", '\033[37m', f"{[enemy.getPrintName() for enemy 
                                                                      in self.souls]}")
        ...
        if 'throwing knife' in self.inventory:
            ...
            try:
                if enemy.type in ['alien priest', 'sun priest'] and [foe for foe in enemies if
                    ...
                    printWithPause(0.5, '\033[96m', f'You hit {enemy.getPrintName()} with your '
        ...
        if 'vial of poison' in self.inventory:
            ...
            try:
                if enemy.type in ['alien priest', 'sun priest'] and [foe for foe in enemies if
                    ...
                    printWithPause(0.5, '\033[96m', f'You hit {enemy.getPrintName()} with your vial, '
                                                    f'poisoning them.')
        ...
        if 'serrated knife' in self.inventory:
            ...
            try:
                if enemy.type in ['alien priest', 'sun priest'] and [foe for foe in enemies if
                    ...
                    printWithPause(0.5, '\033[96m', f'You hit {enemy.getPrintName()} with your knife, '
    ...
    def useOneTimeUseItem(self, enemies):
        ...
        for item in self.inventory:
            if item in oneTimeUseItems:
                printWithPause(0.5, '\033[37m', f'   {item}')
    ...
    def actions(self, enemies, level):
        ...
        if not self.sunPriestSpotted and self.enemiesKilledInLevelFour >= 15:
            ...
            printWithPause(0.5, '\033[96m', "You have made a gap in the mob surrounding you. "
                                            "Through the gap, you see a cathedral in the distance.", 5)

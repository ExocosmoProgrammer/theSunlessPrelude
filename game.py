...
from variables import foesPerLevel, bossesPerLevel, oneTimeUseItems, songsPerLevel
            ...
            if 'cross' in pro.inventory and not enemy.possessed and enemy.type not in ['alien commander',
                ...
                if len(pro.souls) < 2:
                    if getInput('\033[96m', f"Will you take {enemy.getPrintName()}'s soul? y/n:") == 'y':
                        ...
                        printWithPause(0.5, '\033[35m', f'{enemy.getPrintName()} is dead.')
...
def handleCanon():
    ...
    if level == 3 and room < 5:
        ...
        if canonCooldown <= 0:
            ...
            for enemy in foes:
                enemy.hp -= 40
                printWithPause(0.5, '\033[35m', f'{enemy.getPrintName()} was shot by a canon, '
